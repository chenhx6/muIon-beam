...
Use the repository-owned Geant4 Block at [`07_research_system/blocks/geant4/SKILL.md`](../../../07_research_system/blocks/geant4/SKILL.md).
The executable entry point is:

```text
node 07_research_system/blocks/geant4/index.mjs --task path/to/task.yaml
```
