...
const result = { tag, local_commit: localCommit, remote_main: remoteMain, remote_tag: remoteTag, publication, valid: remoteTag === localCommit && (publication ? publication.status === 'published' : true) };
