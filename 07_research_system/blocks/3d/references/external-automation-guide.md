...
来源为 `wzyn20051216/solidworks-automation-skill` 的 MIT 版本和本地 CAD Studio 0.3.4 便携版。外部仓库作为参考实现，当前本地权威路径是 `07_research_system/blocks/3d/scripts/`。
...
- 反复出现的几何失败先写 `07_research_system/blocks/3d/experience-candidates/`，复现后才进入 `07_research_system/blocks/3d/regression/`。
