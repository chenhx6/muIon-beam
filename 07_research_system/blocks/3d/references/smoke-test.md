...
结论：Python 3.14.7 → pywin32/comtypes → SolidWorks 2024 COM → SolidWorks 2024 SP05 原生 Sketch/Feature → SLDPRT 路线已通过最小自动化闭环，可作为 `07_research_system/blocks/3d/create` 的默认建模路线。C# fallback 暂不需要启用。
