...
`07_research_system/blocks/comsol/index.mjs`. The block owns COMSOL model state and execution settings;
...
`07_research_system/blocks/comsol/experience-candidates/` with its conditions, evidence, uncertainty and
...
`07_research_system/blocks/comsol/tests/fixtures/100kev-muon-aperture-failure.yaml` documents the former
