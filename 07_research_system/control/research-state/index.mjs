...
import { researchStatePath } from '../../paths.mjs';

const LOCK_WAIT_MS = 5000;
const LOCK_POLL_MS = 100;
const STALE_LOCK_MS = 10 * 60 * 1000;

function stateDir(root) { return researchStatePath(root); }
...
if (process.argv[1] && path.resolve(process.argv[1]) === path.resolve(fileURLToPath(import.meta.url))) {
  ...
  try {
    ...
    else throw new Error('Usage: node 07_research_system/control/research-state/index.mjs init|status|repair|begin|validation|diagnosis|close [--root path]');
