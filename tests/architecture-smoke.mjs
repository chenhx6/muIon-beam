...
const required = [
  ...
  'contracts/README.md',
  'contracts/geometry-task.yaml',
  'contracts/comsol-task.yaml',
  'contracts/g4-task.yaml',
  'contracts/result-issue-report.yaml',
  'contracts/index.mjs',
  'research-state/index.mjs',
  'research-state/track.mjs',
  'research-state/state.yaml',
  'research-state/NOW.md',
  'research-state/open-problems.yaml',
  'research-state/decision-log.md',
  'research-state/events.jsonl',
  'research-workflow/SKILL.md',
  'research-workflow/README.md',
  'research-workflow/index.mjs',
  'research-workflow/scripts/contracts.mjs',
  'research-workflow/scripts/adapters.mjs',
  'research-workflow/references/goal-management.md',
  'research-workflow/references/physics-reasoning.md',
  'research-workflow/references/task-routing.md',
  'research-workflow/references/sub-agent-dispatch.md',
  'research-workflow/references/failure-diagnosis.md',
  'research-workflow/references/open-problem-tracking.md',
  'research-workflow/references/research-report.md',
